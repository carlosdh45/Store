...
@model({settings: {idInjection: false, mssql: {schema: 'dbo', table: 'OrdenPro'}}})
export class OrdenPro extends Entity {
  @property({
    type: 'number',
    required: true,
    precision: 10,
  ...
  constructor(data?: Partial<OrdenPro>) {
    super(data);
  }
}

export interface OrdenProRelations {
  // describe navigational properties here
}

export type OrdenProWithRelations = OrdenPro & OrdenProRelations;
